...
\! pg_bulkload data/csv1.ctl -i data/data2.csv -o "MULTI_PROCESS=YES" -l results/parallel2.log -P results/parallel2.prs -u results/parallel2.dup -o "PARSE_ERRORS=50"
...
\! pg_bulkload data/csv1.ctl -i data/data2.csv -o "MULTI_PROCESS=YES" -o "WRITER=BUFFERED" -o "DUPLICATE_ERRORS=50" -l results/parallel3.log -P results/parallel3.prs -u results/parallel3.dup -o "PARSE_ERRORS=50"
...
\! pg_bulkload data/csv1.ctl -i data/data2.csv -o "MULTI_PROCESS=YES" -o "WRITER=DIRECT" -o "PARSE_ERRORS=0" -l results/parallel4.log -P results/parallel4.prs -u results/parallel4.dup
...
\! pg_bulkload -i results/data_lost.csv -O public.foo -o MULTI_PROCESS=YES -o TRUNCATE=YES -l results/parallel5.log
SET enable_seqscan = on;
SET enable_indexscan = off;
SET enable_bitmapscan = off;
...
\! pg_bulkload -i results/mem_error.csv -O public.foo -o MULTI_PROCESS=YES -o TRUNCATE=YES -l results/parallel6.log
SET enable_seqscan = on;
SET enable_indexscan = off;
SET enable_bitmapscan = off;
SELECT count(*) FROM public.foo WHERE b IS NOT NULL;
...
\! pg_bulkload -i results/size_over.csv -O public.bar -o MULTI_PROCESS=YES -o TRUNCATE=YES -l results/parallel7.log
SET enable_seqscan = on;
SET enable_indexscan = off;
SET enable_bitmapscan = off;
...
\! pg_bulkload -i results/size_limit.csv -O public.bar -o MULTI_PROCESS=YES -o TRUNCATE=YES -l results/parallel8.log
SET enable_seqscan = on;
SET enable_indexscan = off;
SET enable_bitmapscan = off;
SELECT count(*) FROM public.bar WHERE b IS NOT NULL;
