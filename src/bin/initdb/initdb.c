...
static void setup_polar_settings(void);
...
setup_polar_settings(void)
{
	...
	else
	{
		...
		autoconflines[1] = pg_strdup("# It will be overwritten by the ALTER SYSTEM FOR CLUSTER command.\n");
...
make_postgres(FILE *cmdfd)
{
	...
	/*
	 * POLAR: Internal business can be done in polardb_admin without affect
	 * normal users' business.
	 */
...
initialize_data_directory(void)
{
	 ...
	 * polar_settings.conf is generated at the end of
	 * initialize_data_directory.
	 */
	setup_polar_settings();
